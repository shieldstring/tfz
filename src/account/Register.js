					...
					<div class="bg-white rounded-2xl border shadow-xl p-10 pb-10 w-full">
						<div class="p-5">
							...
							<div class="flex flex-col items-center pt-10 space-y-4 max-w-lg mx-auto">
								<h1 class="font-bold text-lg text-gray-700 w-4/6 text-center">
									Personal Details
								</h1>
							...
							<div class="mt-8 p-4">
								<div>
										...
										<div class="w-full mx-2 flex-1 svelte-1l8159u">
											...
											<div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
												...
												<div class="flex -mr-px">
                                                    ...
                                                    transition"
														>
															<div class="font-sans text-sm font-light  px-3">
																Show
															</div>
														</button>
													</span>
									...
									<div class="flex flex-col md:flex-row pt-4">
										...
										<div class="w-full mx-2 flex-1 mt-2 svelte-1l8159u">
											<label class="text-gray-600 font-normal text-sm mb-9 ml-1">
												Date of birth
											</label>
										...
										<div class="w-full mx-2 flex-1 svelte-1l8159u">
											...
											<div class="mb-3 -mx-2 flex items-end ">
												<div class="px-2 w-1/4">
													<div>
														<label class="text-gray-600 font-normal text-sm mb-2 ml-1">
															Mobile number
														</label>
												...
												<div class="px-2 w-3/4">
													<div>
														<input
															class="w-full px-2 py-2 mb-1 border border-gray-200 rounded focus:outline-none focus:border-indigo-500 transition-colors"
								...
								<div class="flex p-2 mt-4 justify-center">
									<button
										class="text-base hover:scale-110 focus:outline-none flex justify-center px-10 py-2 rounded font-bold cursor-pointer 
