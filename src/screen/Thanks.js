...
<div className='h-full bg-[#E5ECFA]/100'>
            ...
            <div class="flex items-center justify-center pb-20 ">
                    ...
                    <div class="bg-white rounded-2xl border shadow-xl p-10 max-w-lg pb-10 ">
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            ...
                            <a href="##" class="w-full sm:w-auto bg-indigo-500 text-gray-200 shadow-inner rounded hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-gray-300 inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
        ...
        <hr class="my-60 max-w-lg rounded-lg border-b-2 border-violet-500 mx-auto" />
